(function($){
    ...
    $(window).scroll(function(){
      ...
      if( $(window).scrollTop() == 0 ) {
		  ...
		  $('.main_header_nav').removeClass('fixed');
      }else{
		  $('.main_header_nav').addClass('fixed');
...
//        $("select").chosen();
       ...
       if( typeof(bgimg) != "undefined" && bgimg !=""){
        ...
        $(".second-div").hide();
        $(document).on('click','#signup-div',function() {
        ...
        $(".signupForm1").hide();
        $(document).on('click','#show-signup-div',function() {
          //alert('hi');
          $("#loginForm").hide();
          $(".signupForm1").show();
        });

        $(document).on('click','#show-login-div',function() {
           //alert('hi');
          $("#loginForm").show();
          $(".signupForm1").hide();
        });
