...
//        echo '<pre>',print_r($append_message);die;
    ...
    public function destroy_cart() {
       ...
       $this->CI->common_model->deleteRows(array($user_id),'users_cart_items','user_id');
        // Unset browser cart session data.
        $this->CI->session->unset_userdata($this->CI->flexi->cart['name']);
        $this->CI->session->unset_userdata('customer_zipcode');
        $this->CI->session->unset_userdata('customer_city');
        $this->CI->session->unset_userdata('customer_state');
        unset($_SESSION['custom_option']);
        // Reset defaults.
