    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form id="form_add_subAttributesEdit" name="form_add_subAttributesEdit" class="form-horizontal" action="<?php echo base_url(); ?>admin/subAttributesEdit/<?php echo $arr_edit_data[0]['id']; ?>" method="post">
                    <?php
                   // echo form_open_multipart('admin/subAttributesEdit', array('id' => 'form_add_subAttributesEdit', 'name' => 'form_add_subAttributesEdit', 'class' => 'form-horizontal ', 'data-parsley-validate'));
                    ?>
                    
                    <div class="form-group">
                       <label class="control-label col-md-3 col-sm-3 col-xs-12"> Category*</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select id="product_category" name="product_category" class="form-control" required="required">
                                <option value="">Select Category</option>
                                <?php
                                    if(count($product_category) > 0){
                                        foreach($product_category as $key=> $category){ ?>
                                    <option value="<?php echo $category['id'] ?>" <?php if($arr_edit_data[0]['category_id'] == $category['id']){ ?>selected="selected" <?php } ?>><?php echo $category['name'] ?></option> 
                                       <?php }
                                    }
                                ?>
                            </select>
                     ...
                     <div class="form-group">
                        <?php //echo '<pre>';print_r($product_category);die; //echo form_label(lang('product_name'), 'product_name', array('for' => 'product_name', 'class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12" id="_div_attr_view">
                             <select id="attribute_name" name="attribute_name" class="form-control">
                                ...
                                <?php
                                    ...
                                    ?>
                                <option value="<?php echo $cat_details['p_sub_category_id']  ?>" <?php if($arr_edit_data[0]['attribute_id'] == $cat_details['p_sub_category_id']){ ?>selected="selected" <?php } ?>><?php echo $cat_details['attrubute_value'] ?></option>   
                                     <?php }  }
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="subattribute_name" id="subattribute_name" placeholder="Sub Attribute Name" value="<?php echo $arr_edit_data[0]['name']; ?>" class="form-control" required="required" />
                           
                        </div>
                    </div>
                    <input type="hidden" name="edit_id"  id="edit_id" value="<?php echo $arr_edit_data[0]['id']; ?>" />
