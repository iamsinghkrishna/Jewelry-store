        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    echo form_open('admin_library/update_coupn/'.$id, array('name' => 'form_add_coupon','id' => 'form_add_coupon', 'class' => 'form-horizontal ', 'data-parsley-validate'));
                    ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            echo form_input(array(
                                ...
                                'onblur' => "chkCouponCodeEdit('coupon_code','coupon_code');",
                                'class' => 'form-control',
                                'required' => 'required',
                                'min' => '0',
...
//                            ));
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input readonly  min='<?php echo date("Y-m-d"); ?>' type="text" name="from_date" class="form-control" value="<?php echo $discount_data['disc_valid_date']?>"> 
                        </div>
                    </div>
                    <div class="form-group">
                        <?php echo form_label(lang('end_d'), 'end_d', array('for' => 'end_d', 'class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input readonly  type="text" name="to_date" class="form-control" value="<?php echo $discount_data['disc_expire_date']?>"> 
                        </div>
                    </div>
<!--                    <div class="form-group">
                    ...
                    <input type="hidden" name="disc_id" id="disc_id" value="<?php echo $discount_data['disc_id']; ?>" />
...
<script>
    $(document).ready(function () {
        ...
        curInnerHTML = curInnerHTML.replace('Call to an unknown method : "get_db_discount_tax_method_array"', "");
