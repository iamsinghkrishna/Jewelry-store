<?php
//echo '<pre>', print_r($product_details);echo $product_details['instagram_image'];
//die()
?>
<?php $ischeck = ''; ?>
<?php $val     = ''; ?>
...
//                                    htmlspecialchars($product_details['product_name'],ENT_QUOTES,'UTF-8'))
//                            ));
                            ?>
                            <input type="text" id="product_name" name="product_name" placeholder="Product Name" class="form-control" required="required" value="<?php echo htmlspecialchars($product_details['product_name'],
                                ENT_QUOTES, 'UTF-8') ?>">
                        </div>
                    </div>
...
?>
                            ...
                            <select class="form-control" id="is_instagram_product" name="is_instagram_product" onchange="getInstagramImage(this.value);">
                                <option value=""> Select Instagram Image</option>
                                        ...
                                        <option style="overflow: hidden;white-sapce: no-wrap;text-overflow: ellipsis;width: 430px !important;" value="<?php echo $arr_current_image[1]; ?>" <?php if ($product_details['instagram_image']
                                                    == $arr_current_image[1]) {
                                                    ?>selected="selected" <?php } ?>><?php echo $insta_feeds[$i]; ?></option>
                             <?php
                             }
                         }
                         ?>
                    ...
                    <div class="form-group">
                                <?php
                                echo form_label(lang('product_category'),
                                    'product_category',
                            ...
                            <div class="col-md-6 col-sm-3 col-xs-3">
                                <div class="categoryListWrap">
                                    ...
                                    if (count($arr_sub_attribute) > 0) {
                                        ...
                                        $arr_sub_category_id = explode(',',
                                            $sub_category_id);
                                        $i                   = 0;
                                        foreach ($arr_sub_attribute as $key => $sub_attribute) {
                                            ?>
                                            <label class="checkbox-inline">
                                                <input onchange="getThirdLevelSubCategoryEdit();" type="checkbox" name="sub_category[]" id="sub_category" <?php if (in_array($sub_attribute['id'],
                                                    $arr_sub_category_id)) {
                                                ?>checked<?php } ?> value="<?php echo $sub_attribute['id']; ?>" /> <?php echo $sub_attribute['attrubute_value']; ?>
                                            </label><br>
        <?php
        $i++;
    }
...
?>
                    ...
                    <div id='showInitialDiv' style='display:none'>
                        <div class="clearfix"></div>
                        <div class="form-group">
<?php echo form_label('Inicial Product Letter',
    'initial_letter',
    array('for' => 'initial_letter', 'class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <?php
                            echo form_input(array(
                                'type' => 'text',
                                ...
                                'class' => 'form-control',
                                'required' => 'required',
                                'value' => set_value('initial_letter',
                                    $product_details['initial_letter'])
                            ));
                            ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <?php echo form_label('Inicial Product Color',
                                'initial_color',
                                array('for' => 'initial_color', 'class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?php
                                echo form_input(array(
                                    'type' => 'text',
                                    ...
                                    'class' => 'form-control',
                                    'required' => 'required',
                                    'value' => set_value('initial_color',
                                        $product_details['initial_color'])
                                    //'required' => 'required',
                                ));
                                ?>
                            </div>
                        ...
                        <div class="form-group">
<?php echo form_label('Inicial Product MM',
    'initial_mm',
    array('for' => 'initial_color', 'class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
                            <div class="col-md-6 col-sm-6 col-xs-12">
<?php
echo form_input(array(
    ...
    'class' => 'form-control',
    'required' => 'required',
    'value' => set_value('initial_mm', $product_details['initial_mm'])
    //'required' => 'required',
));
?>
                            </div>
    ...
    != NULL || $product_details['variant_size'] != NULL) {
    ?>selected="selected" <?php } ?>> Product Has Variant</option>
...
?>>
                        <div class="form-group">
                        <?php
                        echo form_label('Variant Color', 'variant_color',
                        ...
                        <div class="form-group">
                            <?php
                            echo form_label('Variant Size', 'variant_size',
                    ...
                    <div class="form-group">
                            <?php
                            echo form_label(lang('product_quantity'),
                                'product_quantity',
                    ...
                    <div class="form-group">
                            <?php
                            echo form_label(lang('product_price'),
                                'product_price',
...
?>
                    ...
                    <div class="form-group">
                            <?php
                            echo form_label(lang('product_sku'), 'product_sku',
...
?>
                    ...
                    <div class="form-group">
<?php
echo form_label(lang('product_shipping_region'), 'product_shipping_region',
...
<?php if ($imgCnt > 0) { ?>
    ...
    <?php } ?>
                    ...
                    <div class="form-group">
                    <?php echo form_label(lang('product_images'),
                        'product_images',
                        array('for' => 'product_images', 'class' => 'control-label col-md-3 col-sm-3 col-xs-12'));
                    ?>
                        <div class="col-md-6 col-sm-6 col-xs-12">
...
?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-1">
                            ...
                            <?php
                            if (isset($product_details['product_images_details'])
...
<?php } ?>
                    ...
                    <div class="form-group">
<?php
echo form_label(lang('hover_images'), 'hover_images',
...
//                                'required' => 'required',
                    ...
                    <div class="form-group">
                                    <?php
                                    echo form_label(lang('product_desc'),
                                        'product_desc',
...
//));
?>
                            <textarea id='product_desc' name='product_desc' placeholder="Description" class="form-control" required="required"><?php echo htmlspecialchars($product_details['description'],
    ENT_QUOTES, 'UTF-8'); ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            echo form_input(array(
                                ...
                                'class' => 'form-control',
                                'value' => set_value('clover_id',
                                    $product_details['clover_id'])
                            ));
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
<?php
echo form_label(lang('product_status'), 'product_status',
