                    ...
                    <div class="table-responsive">
                        <form id="form_offer" method="post" action="<?php echo base_url() ?>admin/inventory">
                            ...
                            <?php// if(!$this->uri->segment('4')){?>
                                <!--<a class="btn btn-default btn-xs" href="<?php echo base_url('admin/inventory/orders/showlimit')?>">Load more</a>
                                <?php //} else{ ?>
                                  <a class="btn btn-default btn-xs" href="<?php echo base_url('admin/inventory/orders')?>">Back</a>
    <?php ////}
...
<script>
    $(document).ready(function () {
        ...
        "ajax": '<?php echo base_url()?>admin/inventory/getAllOrders/',
        "aaSorting": [],		
    } );
    });
</script>
