                            ...
                            <tbody>
                                ...
                                <?php foreach ($product_details as $productData) { //if($productData['isactive']==1){ ?>
                                    <tr>
                                        ...
                                        <td><?php echo isset($productData['name']) ? $productData['name'] : $productData['name']; ?></td>
                                        <td><?php echo isset($productData['phone']) ? $productData['phone'] : ''; ?></td>
                                        <td><?php echo isset($productData['address']) ? $productData['address'] : ''; ?></td>
