        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                    echo form_open_multipart('admin/inventory/edit-store/' . $id, array('name' => 'form_add_coupon', 'id' => 'form_add_coupon', 'class' => 'form-horizontal ', 'data-parsley-validate'));
                    ?>
                    ...
                    <div class="form-group">
                        <?php echo form_label(('Status'), 'Sratus', array('for' => 'phone', 'class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <?php
                            $options = array(
                                '1' => 'Active',
                            ...
                            echo form_dropdown('status', $options, $store_data[0]['is_active'], 'class="form-control" id="my_id"');
                            ?>
                        </div>
                    </div>
