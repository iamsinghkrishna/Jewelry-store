                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-8">
                            ...
                            echo form_open('home/update_cart',
                                array('id' => 'form_filter_product', 'class' => ' ',
...
//                                        echo '<pre>';print_r($cart_items);die;
                                        ...
                                        foreach ($cart_items as $sid => $cData) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    echo ($cData['item_url'] != '')
                                                            ? base_url().$cData['item_url']
                                                            : base_url()."assets/images/product-no-image2.jpg";
                                                    ?>" onerror="this.src='<?php echo base_url('assets/images/product-no-image2.jpg'); ?>'">
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <?php
                                                    if ($cData['item_stock'][0]['quantity']
                                                        < 1 || ($cData['quantity'])
                                                        > $cData['item_stock'][0]['quantity']) {
                                                        echo "<span style='color:red'>Out Of Stock </span>";
                                                        if ($cData['item_stock'][0]['quantity']
                                                            > 0) {
                                                            echo "<span style='color:red'>(".$cData['item_stock'][0]['quantity']." item available)";
                                                        }"</span>";
                                                    } else {
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <input type="number" name="quantity_<?php echo $cData['id']; ?>" class="form-control" id="" value="<?php echo $cData['quantity'] ?>" min="1" <?php if (($cData['quantity']) > $cData['item_stock'][0]['quantity']
                                                        && $cData['options']['Prebook']
                                                        == 'false'){ echo 'max="'.$cData['item_stock'][0]['quantity'].'"';}else{ echo 'max="999"';}?> title="<?php echo $cData['item_stock'][0]['quantity'];?> itesm available in stock. You can contact admin for bulk orders." required="">
                            ...
                            <table>
                                <?php foreach ($discounts as $discount) { ?>
                                            ...
                                            <tr style="background: rgba(236, 234, 234, 0.56);margin: 10px;border: 1px solid #ded5d5;">

                                                <td style="padding: 15px;" colspan="3">
                                                    <?php echo trim($discount['description']); ?>

                                                </td>

                                                <td style="padding: 15px;" colspan="4"><b><?php echo $discount['value']; ?></b></td>
...
// Get an array of all discount codes. The returned array keys are 'id', 'code' and 'description'.
                                        ...
                                        if ($coupon_name == '' && count($discount_data)
                                            < 1) {
                                            ?>
                        ...
                        <style type="text/css">
                            ...
                            .wrap-btns .wrap-input {
                                width: 100%;
                                padding-right: 73px;
                            }

                            .wrap-btns .pincode-button {
                                position: absolute;
                                right: 0;
                                top: 0;
                        ...
                        <div class="col-sm-12 col-md-4">
                            ...
                            <div class="box-cart-total" style="padding-bottom: 23px;">
                                <h2 class="title">Shipment</h2>

                                <select id="cust_country" style="width: 100%;margin-bottom: 20px;">
                                    <option <?php
                                    if ($this->session->userdata('customer_country')
                                        == 'US') echo "selected";
                                    ?> value="US">USA</option>
                                    <option <?php
                                    if ($this->session->userdata('customer_country')
                                ...
                                <div class="wrap-btns">
                                    <input class="wrap-input" value="<?php
                                    if ($this->session->userdata('customer_zipcode')
                                        != '') {
                                        echo $this->session->userdata('customer_zipcode');
                                    } elseif ($account_details[0]['billing_zipcode']
                                        != '') {
                                        echo $account_details[0]['billing_zipcode'];
                                    } else {
                                        echo "";
                                    }
                                    ?>" type="text" maxlength="5" placeholder='Postal code' id="cust_zipcode">
                                    <button type="button"  class="btn btn-default bt-xs pincode-button" onClick="getShippingInfo()">Check</button>
                                </div>
...
//                                        echo "<pre>";print_r($cart_summary);die;
                                                if (!empty($cart_summary['item_summary_total'])) {
                                                    echo number_format($cart_summary['item_summary_total'],
                                                        2);
                                                } else {
...
//                                     print_r($discounts);die;
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="price"><?php
                                                if (!empty($cart_summary['item_summary_total'])
                                                    ...
                                                    != '') ? "$".number_format($custom_option['shipping_total'],
                                                            2) : '';
                                                    echo '</span>';
                                                }
                                                ?></span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="price">$<span id="TaxRate"><?php
                                                    ...
                                                    != 0) ? number_format($custom_option['tax_total'],
                                                            2) : '0.00';
                                                    ?></span>
                        ...
                        <div class="col-md-6 login_form_div">
                            ...
                            <form role="form" id="signupForm" class="signupForm1">
                                ...
                                <p class="form-row form-row-wide">
                                    ...
                                    <input type="text" required name="first_name" class="input-text" id="first_name" placeholder="First Name" />
                                </p>

                                <p class="form-row form-row-wide">

                                    <input type="text" required name="last_name" class="input-text" id="last_name" placeholder="Last Name" />
                                </p>
                                ...
                                <p class="form-row form-row-wide">
                                    <input type="password" name="password_confirm" class="input-text" id="password_confirm" placeholder="Confirm Password" />
...
<script type="text/javascript">
    ...
    function getShippingInfo() {
        ...
        if (cust_zipcode === '' || cust_country === '') {
            $("#message_ship").html('<p style="color:red">Please enter postal code</p>');
            return false;
        }
        $(".pincode-button").html('<i class="fa fa-spinner fa-spin"></i>');
        $.ajax({

            url: base_url + 'admin/ups/getRates',

            data: {cust_zipcode: cust_zipcode, cust_country: cust_country},
...
//                    location.reload();
                    ...
                    if (response.status === '1') {
                        ...
                        $("#st_message").html('<div class="alert alert-danger"><strong>Error! </strong>' + response.msg + '</div>');
...
//    $("#cust_zipcode").keydown(function (e) {
