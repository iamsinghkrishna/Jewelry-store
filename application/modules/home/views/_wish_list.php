                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-8">
                        <?php if (isset($product_details) && !empty($product_details)) { ?>
                            ...
                            <div class="table-responsive" id="mainShareList">    
...
//                                            print_r($wish);die();
                                   ...
                                   <tr id="arr_<?php echo $wish['id']; ?>">
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-solid btn-sm" onclick="deleteWishlist(<?php echo $wish['id']; ?>)">
                                                        <i class="fa fa-trash-o"></i>
                                                    </button>
                                                    <!--<i title="Delete" style="cursor:pointer;" class="fa fa-trash" aria-hidden="true" onclick="deleteWishlist(<?php echo $wish['id']; ?>)"></i>-->
                                                </td> 
                                        </tr>
                                        <?php } }?>
                                    </tbody>
                        ...
                        <?php } ?>
                            <div class="text-center" id="emptyShareList" style="display:none;">
                                <p><i class="fa fa-5x fa-heart text-danger"></i></p>
                                <p>Your wishlist is empty</p>
                            </div>
                    </div>
...
//        alert(id);
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data.count === 1){
                    $('#mainShareList').css('display','none');
                    $('#emptyShareList').css('display','block');
                }
                $('#arr_' + id).remove();
