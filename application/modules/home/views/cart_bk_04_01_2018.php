                                        ...
                                        foreach ($cart_items as $sid => $cData) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <input type="number" name="quantity_<?php echo $cData['id']; ?>" class="form-control" id="quantity_<?php echo $cData['id']; ?>" value="<?php echo $cData['quantity'] ?>" min="1" <?php if ($cData['options']['Prebook']
                                                        == 'false'){ echo 'max="'.$cData['item_stock'][0]['quantity'].'"';}else{ echo 'max="999"';}?>  required="">
                                                ...
                                                <td class="text-center"><strong>$<?php echo (floatval($cData['internal_price'])
                            ...
                            <div class="box-cart-total">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right;"><span class="price">$<?php
...
//                                     print_r($discounts);die;
    ...
    <?php if (!empty($discounts['total']['value'])) { ?>
                                        <tr>
                                            ...
                                            <td style="text-align: right;"><span class="price">$<span id=""><?php
        echo str_replace('US $', ' ', $discounts['total']['value']);
        ?></span>
    ...
    <?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right;"><span class="price">$<span id="TaxRate"><?php
                                    ...
                                    <tr class="order-total">
                                        ...
                                        <td style="padding-right: 0"><span id="summary_total" class="price">$<?php
                                                if (!empty($cart_summary['item_summary_total'])) {
                        ...
                        <div class="col-md-6 login_form_div">
                            ...
                            <form id="loginForm" method="post">
                                ...
                                <p class="form-row form-row-wide">
                                    ...
                                    <input type="text" name="username" required class="input-text" id="email1" placeholder="Email Address" />
                                </p>
