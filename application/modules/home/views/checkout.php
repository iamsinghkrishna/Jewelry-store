                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <p> <?php if (!($this->flexi_cart->shipping_location_name(3))) { ?>
                                            ...
                                            <input type="text"  required name="checkout[shipping][post_code]" id="cust_zipcode" onkeyup="getShippingInfo()" value="<?php
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <p><select onchange="getShippingInfo()" id="checkout_shipping_country" required name="checkout[shipping][country]" class="width_400">
                        ...
                        <div class="form-checkout">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <p> <input type="text" name="checkout[billing][post_code]" required onkeyup="getBillingZipcode()" id="checkout_billing_post_code" value="<?php
                                       if($account_details[0]['billing_zipcode']!=0) echo $account_details[0]['billing_zipcode']; else if(set_value('checkout[billing][post_code]')) echo set_value('checkout[billing][post_code]');
                                        ?>" placeholder="Post / Zip Code" class="width_200"/>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <p><select onchange="getBillingZipcode()" id="checkout_billing_country" required name="checkout[billing][country]" class="width_400">

                                            <option  value="US" <?php
                                                     if ($account_details[0]['billing_country']
                                                         == 'US') {
                                                         ?>selected="selected" <?php } ?>> USA </option>
                                            <option value="MX" <?php
                                                    if ($account_details[0]['billing_country']
                                                        == 'MX') {
                                                        ?>selected="selected" <?php } ?>> Mexico </option>
...
<?php
echo form_error('checkout[phone]', '<span style="color:red" class="error">',
    '</span>');
?>
...
//});
    ...
    function getShippingInfo() {
        ...
        var cust_country = $("#checkout_shipping_country").val();
        $('.proceed_checkout').prop('disabled', true);
        if ($("#cust_zipcode").val().length > 4) {
//        if (cust_zipcode === '') {
//            return false;
//        }
//alert("after enter 4");
 $('.proceed_checkout').prop('disabled', false);
         ...
         $('.proceed_checkout').prop('disabled', true);
            $("#message_ship").html('<p style="color:red">Please enter 5 digit postal code</p>');
        }

    }

//    $("#checkoutfrm").submit(function (e) {
////    e.preventDefault();
//    $('#proceed_checkout').prop('disabled', true);
//        getShippingInfo();
//    });
...
<?php if ($account_details[0]['billing_zipcode'] != '' || $this->session->userdata('customer_zipcode')) { ?>
    <script>
        getShippingInfo();
    </script>
<?php } ?>
...
//            $('#checkout_billing_post_code').keyup(function () {
            if ($("#checkout_billing_post_code").val().length > 4) {
                var cust_zipcode = $("#checkout_billing_post_code").val();
                var cust_country = $("#checkout_billing_country").val();
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.status === '0') {
                            ...
                            $("#checkout_billing_post_code").val("")

                        } else {
                            $("#checkout_billing_city").val(response.city_name);
                            $("#checkout_billing_state").val(response.state_name);
                            $(".bill_zipcode_error").html("");
                        }
                ...
                $(".bill_zipcode_error").html('<p style="color:red">Please enter 5 digit postal code</p>');
            }
//            });
        }
//        }); //END document.ready
