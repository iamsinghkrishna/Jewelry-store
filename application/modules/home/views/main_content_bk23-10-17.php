...
<center class="slider_below_text">
    "Vaskia is timeless elegance: <br/>
...
<?php
if (!empty($prodcut_cat_detail_new)) {
//    echo "<pre>";
//    print_r($prodcut_cat_detail_new);
//    die;
    foreach ($prodcut_cat_detail_new as $key => $val) {
        ?>
...
//                echo "<pre>";
//                print_r($val['product_details']);die;
