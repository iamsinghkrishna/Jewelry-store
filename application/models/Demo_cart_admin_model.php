...
//			$row = $this->input->post('update');
        ...
        $sql_update = array(
            ...
            $this->flexi_cart_admin->db_column('discounts', 'method') => $this->input->post('coupon_method'), // $this->input->post('coupon_method'),
            $this->flexi_cart_admin->db_column('discounts', 'tax_method') => $this->input->post('tax_method'), //$this->input->post('tax_method'),
