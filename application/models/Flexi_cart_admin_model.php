...
//                    $sql_update[$table_col_name] = $_SESSION['custom_option']['tax_total']; 
                }
        ...
        $tax_total =  $this->session->userdata('tax_total');
        $shipping_total =  $this->session->userdata('shipping_total');
        $cust_arr['ord_order_number'] = $sql_update['ord_order_number'];
        $cust_arr['ord_cart_data_fk'] = $sql_update['ord_cart_data_fk'];
        $cust_arr['ord_user_fk'] = $sql_update['ord_user_fk'];
        $cust_arr['ord_item_summary_total'] = $sql_update['ord_item_summary_total'];
        $cust_arr['ord_item_summary_savings_total'] = $sql_update['ord_item_summary_savings_total'];
        $cust_arr['ord_shipping_total'] = $shipping_total;
        $cust_arr['ord_item_shipping_total'] = $shipping_total + $sql_update['ord_item_summary_total'];
//        $cust_arr['ord_summary_discount_desc'] = $sql_update['ord_summary_discount_desc'];
        $cust_arr['ord_summary_savings_total'] = str_replace('US $', ' ', $discounts['total']['value']);
        $cust_arr['ord_savings_total'] = $sql_update['ord_savings_total'];
        $cust_arr['ord_surcharge_total'] = $sql_update['ord_surcharge_total'];
        $cust_arr['ord_reward_voucher_total'] = $sql_update['ord_reward_voucher_total'];
        $cust_arr['ord_tax_rate'] = '7';
        $cust_arr['ord_tax_total'] = $tax_total;
        $cust_arr['ord_sub_total'] = $sql_update['ord_sub_total'];
        $cust_arr['ord_total'] = $total;
        $cust_arr['ord_total_rows'] = $sql_update['ord_total_rows'];
        $cust_arr['ord_total_items'] = $sql_update['ord_total_items'];
        $cust_arr['ord_total_weight'] = $sql_update['ord_total_weight'];
        $cust_arr['ord_total_reward_points'] = $sql_update['ord_total_reward_points'];
        $cust_arr['ord_currency'] = $sql_update['ord_currency'];
        $cust_arr['ord_exchange_rate'] = $sql_update['ord_exchange_rate'];
        $cust_arr['ord_status'] = $sql_update['ord_status'];
        $cust_arr['ord_demo_bill_name'] = $sql_update['ord_demo_bill_name'];
        $cust_arr['ord_demo_bill_company'] = $sql_update['ord_demo_bill_company'];
        $cust_arr['ord_demo_bill_address_01'] = $sql_update['ord_demo_bill_address_01'];
        $cust_arr['ord_demo_bill_address_02'] = $sql_update['ord_demo_bill_address_02'];
        $cust_arr['ord_demo_bill_city'] = $sql_update['ord_demo_bill_city'];
        $cust_arr['ord_demo_bill_state'] = $sql_update['ord_demo_bill_state'];
        $cust_arr['ord_demo_bill_post_code'] = $sql_update['ord_demo_bill_post_code'];
        $cust_arr['ord_demo_bill_country'] = $sql_update['ord_demo_bill_country'];
        $cust_arr['ord_demo_ship_name'] = $sql_update['ord_demo_ship_name'];
        $cust_arr['ord_demo_ship_company'] = $sql_update['ord_demo_ship_company'];
        $cust_arr['ord_demo_ship_address_01'] = $sql_update['ord_demo_ship_address_01'];
        $cust_arr['ord_demo_ship_address_02'] = $sql_update['ord_demo_ship_address_02'];
        $cust_arr['ord_demo_ship_city'] = $sql_update['ord_demo_ship_city'];
        $cust_arr['ord_demo_ship_state'] = $sql_update['ord_demo_ship_state'];
        $cust_arr['ord_demo_ship_post_code'] = $sql_update['ord_demo_ship_post_code'];
        $cust_arr['ord_demo_ship_country'] = $sql_update['ord_demo_ship_country'];
        $cust_arr['ord_demo_email'] = $sql_update['ord_demo_email'];
        $cust_arr['ord_demo_phone'] = $sql_update['ord_demo_phone'];
        $cust_arr['ord_demo_comments'] = $sql_update['ord_demo_comments'];
        ...
        $this->db->update($this->flexi->cart_database['order_summary']['table'], $cust_arr, $sql_where);       
        return TRUE;
    }
            ...
            foreach ($order_detail_columns as $table_col_alias => $table_col_name) {
                ...
                if ($table_col_name) {
                    ...
                    // Item options.
                        ...
                        $item_options = $this->flexi_cart_admin->item_options_array($row_id);

                        if ($item_options !== FALSE) {
                            $sql_set[$table_col_name] = serialize($item_options);
                        }
                    }
                    // Item status message.
