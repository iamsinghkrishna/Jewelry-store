...
//                                                    echo "<pre>";print_r($array1);die;
			  ...
			  <li class="">
                            ...
                            <li id = "menu-item-244" class = "profile-drop-down menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-244 menu-item-has-children">

                                    <a href = "#" class="noeffect"><span class = "title-nav-mn">
                                            <?php if($dataHeader['picture_url'] != ''){ ?>
                                            <img src="<?php echo $dataHeader['picture_url']; ?>" class="user-icon">
                                            <?php } else{?>
                                                <img src="<?php echo base_url() ?>assets/images/user_img.png" class="user-icon">
                                            <?php } ?>
                                    ...
                                    <ul role = "menu" class = " sub-menu">
                                        ...
                                        <li id = "menu-item-246" class = "menu-item menu-item-type-custom menu-item-object-custom menu-item-246">
                                            ...
                                            <a href = "<?php echo base_url() ?>home/my_profile"><span class = "title-nav-mn">My Profile</span></a></li>
                                        <li id = "menu-item-246" class = "menu-item menu-item-type-custom menu-item-object-custom menu-item-246">

                                            <a href = "<?php echo base_url() ?>home/orders"><span class = "title-nav-mn">My Orders</span></a></li>

                                        <li id = "menu-item-246" class = "menu-item menu-item-type-custom menu-item-object-custom menu-item-246">

                                            <a href = "<?php echo base_url() ?>home/wishlist"><span class = "title-nav-mn">My Wishlist</span></a></li>

                                        <li id = "menu-item-929" class = "menu-item menu-item-type-post_type menu-item-object-post menu-item-929"><a href = "<?php echo base_url() . 'auth/logout_home' ?>"><span class = "title-nav-mn">Logout</span></a></li>
