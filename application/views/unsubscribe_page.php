        ...
        <header id="header">
            ...
            <div id="intro">
                <h1>
                    ...
                    <span class="highlight-new">UNSUBSCRIBE SUCCESSFUL</span> 
                    <br>
                    <span class="text" style="color: #fff">
                   You will no longer receive our WEEKLY NEWSLETTER.     
We’re sad to see you go. We would love to see you back in future.</span>
