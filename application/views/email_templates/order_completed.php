                    ...
                    <div class="content">
                        <table bgcolor="#0c1f2b">
                            <tr>
                                ...
                                <td align="right">
                                    <h6 class="collapse" style="color:#666">Order Completed</h6>	
                                </td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <p><img src="<?php echo base_url('assets/images/order-completed.jpg')?>" alt="" /></p>
                                    <!-- /Hero Image -->

                                    <br/>

                                    <p>Thanks for shopping with <?php echo config_item('website_name'); ?>. Your order with order id <?php echo ucfirst($data['ord_order_number']); ?> has been completed.</p>

                                    <p></p>
                                    <p>We would love to see you back on our site with more excited jewelry products.</p>
