                    ...
                    <div class="content">
                        <table bgcolor="#0c1f2b">
                            <tr>
                                ...
                                <td align="right">
                                    <h6 class="collapse" style="color:#666">Order Shipped</h6>
                                </td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <p><img src="<?php echo base_url('assets/images/order-shipped.jpg')?>" alt="" /></p>
                                    <!-- /Hero Image -->

                                    <br/>

                                    <p>Shipement has been created for your order with order id <?php echo ucfirst($data['ord_order_number']); ?></p>
