                    ...
                    <div class="content">
                        <table bgcolor="#0c1f2b">
                            <tr>
                                ...
                                <td align="right">
                                    <h6 class="collapse" style="color:#666">Order Cancelled</h6>	
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="content">
                        <table>
                            <tr>
                                <td>
                                    <br/>
                                    <h3>Hi <?php echo $data['ord_demo_ship_name']; ?>,</h3>

                                    <!-- You may like to include a Hero Image -->
                                    <p><img src="<?php echo base_url('assets/images/order-cancelled.jpg')?>" alt="" /></p>
                                    <!-- /Hero Image -->

                                    <br/>

                                    <p>Your order <?php echo ucfirst($data['ord_order_number']); ?> was cancelled</p>

                                    <p></p>
                                    <p>Your payment has been refunded. You will get it back within 7 days in your account.</p>
